...
public class NewContactCreationTests {
  ...
  public void testNewContactCreation() {
    gotoContactPage();
    fillNewContactForm(new ContactData("first name", "middle name", "last name", "new title", "new company", "first address", "first home", "first mobile", "first work", "first mail", "second mail", "1900", "second address", "second home"));
